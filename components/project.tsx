...
export default function Project({
  ...
  return (
    ...
    >
      <section className=" bg-white max-w-[50rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[22rem] mb-3 sm:mb-8 last:mb-0 group-even:pl-8 hover:bg-gray-100 transition">
